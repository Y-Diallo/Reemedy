...
import { addRemedy } from "../../scripts/firebase";
    ...
    <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-75 text-black overflow-y-auto">
      <div className="bg-white p-6 rounded-lg shadow-md max-w-lg mt-5 sm:mt-0  overflow-y-auto h-4/5 w-4/5">
        ...
        <div className="mb-4">
          ...
          {remedy.usageMethod &&
            remedy.usageMethod.map((usage: string, index: number) => (
        ...
        <div>
          ...
          <ul className="list-disc pl-5">
            {remedy.benefits &&
              remedy.benefits.map((benefit: string, index: number) => (
        ...
        <div className="flex justify-center">
          <button className=" bg-gradient-to-br from-green-600 to-amber-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 rounded-lg py-2 px-4 my-4 text-white font-bold" onClick={()=>{
            addRemedy({remedyId:remedy.id})
            }}>Add to Saved</button>
        </div>
        <div>
          <div className="flex items-center justify-between mb-4">
            <h5 className="text-xl font-bold leading-none text-gray-900 text-black">
              Comments{" "}
            </h5>
            <a
              href="#"
              ...
              <li className="py-3 sm:py-4">
                <div className="flex items-center ">
                  <div className="flex-shrink-0">
                    <img
                      className="w-8 h-8 rounded-full"
                      src="https://images.unsplash.com/photo-1521572267360-ee0c2909d518?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt="Lana image"
                    />
                  </div>
                  <div className="flex-1 min-w-0 ms-4">
              ...
              <li className="pt-3 pb-0 sm:pt-4">
                <div className="flex items-center ">
                  <div className="flex-shrink-0">
                    <img
                      className="w-8 h-8 rounded-full"
                      src="https://images.unsplash.com/photo-1614283233556-f35b0c801ef1?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      alt="Thomas image"
                    />
                  </div>
                  <div className="flex-1 min-w-0 ms-4">

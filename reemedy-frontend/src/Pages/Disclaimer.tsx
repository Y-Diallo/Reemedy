      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center z-20">
          ...
          <h2 className="text-black text-lg mb-2">
            This app is not a substitute for professional medical or health
            advice, examination, diagnosis, or treatment. This app disclaims any
            liability for the decisions you make from this information.
          </h2>
        </div>
        <img
          src={blobImage}

  ...
  return (
   ...
   <div className="relative text-black w-screen h-screen flex flex-col justify-center p-8 overflow-hidden">
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <img src={blobImage} className="absolute left-0 object-cover transform scale-150 -top-80 -left-20 z-2" alt="Blob 1" />
        <img src={blobImage} className="absolute -bottom-80 -right-40 object-cover transform scale-150 mb-0 mr-0 mb-0 z-1" alt="Blob 2" />
      </div>

...
function Navbar() {
  ...
  return (
    <nav>
      <div
        className="fixed z-50 w-80 h-16 max-w-lg -translate-x-1/2 rounded-full bottom-4 left-1/2 "
        style={{ backgroundColor: "#404046" }}
      >
